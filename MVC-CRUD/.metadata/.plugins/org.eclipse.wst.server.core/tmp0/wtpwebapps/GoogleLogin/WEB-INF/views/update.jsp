...
<body>
		...
		<form:form action="update-form" modelAttribute = "student" method="post">
			<form:label path="name">Name</form:label>
			<br>
			<form:input path="name" value = "${data.name }"/><form:errors path = "name" cssClass = "error" />
			<br>
			<br>
			<form:label path="email">email</form:label>
			<br>
			<form:input path="email" value = "${ data.email}" />&nbsp;
			<br>
			<br>
			<form:label path="mobile">mobile</form:label>
			<br>
			<form:input path="mobile" value = "${data.mobile}" />&nbsp;
			<br>
			<br>
			<form:label path="dob">birth date</form:label>
			<br>
			<form:input path="dob" id="datepicker" value = "${data.dob}"/>&nbsp;
			<br>
			<br>
